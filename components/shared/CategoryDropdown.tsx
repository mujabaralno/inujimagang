...
import {
  ...
  import { IFacilityCategory } from "@/lib/database/models/facilityCategory.model"
  ...
  const Dropdown = ({ value, onChangeHandler }: DropdownProps) => {
    const [categories, setCategories] = useState<IFacilityCategory[]>([])
    ...
    useEffect(() => {
      const getCategories = async () => {
        ...
        categoryList && setCategories(categoryList as IFacilityCategory[])
      }
