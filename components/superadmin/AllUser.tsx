...
const TableAllUser = ({ users }: TableAllUserProps) => {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200">
      <Table>
        <TableHeader>
          <TableRow className="bg-linear-to-r from-gray-50 to-slate-50 hover:from-gray-100 hover:to-slate-100">
        ...
        <TableBody>
          {users.map((user, index) => (
            <TableRow 
              key={index} 
              className="hover:bg-linear-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200 group"
            >
